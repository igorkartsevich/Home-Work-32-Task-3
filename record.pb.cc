...
constexpr Record::Record(
  ...
  : adress_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Record, adress_),
  PROTOBUF_FIELD_OFFSET(::Record, name_),
  PROTOBUF_FIELD_OFFSET(::Record, occupation_),
  PROTOBUF_FIELD_OFFSET(::Record, foreign_trade_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_record_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "on\030\004 \001(\t\022\025\n\rforeign_trade\030\005 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_record_2eproto = {
  false, false, 111, descriptor_table_protodef_record_2eproto, "record.proto", 
...
class Record::_Internal {
 public:
  ...
  static void set_has_foreign_trade(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Record::Record(const Record& from)
  ...
  adress_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ...
  if (from._internal_has_adress()) {
    adress_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_adress(), 
  ...
  ::memcpy(&year_, &from.year_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreign_trade_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_trade_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&foreign_trade_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_trade_));
}
...
inline void Record::SharedDtor() {
  ...
  adress_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:Record)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      adress_.ClearNonDefaultToEmpty();
    }
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&foreign_trade_) -
        reinterpret_cast<char*>(&year_)) + sizeof(foreign_trade_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Record.adress");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_foreign_trade(&has_bits);
          foreign_trade_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreign_trade(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Record)
  ...
  if (cached_has_bits & 0x0000001fu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_adress(from._internal_adress());
    }
    if (cached_has_bits & 0x00000002u) {
    ...
    if (cached_has_bits & 0x00000010u) {
      foreign_trade_ = from.foreign_trade_;
    }
